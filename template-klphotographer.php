...
/* Template Name: Services Photographer
...
<div class="container">
    <div class="page-wrap">
		...
		<div class="col-md-12 mb-5">
            <?php echo do_shortcode('[Best_Wordpress_Gallery id="7"]');?>
        </div>
		...
		<div class="col-md-12 mb-5">
            <?php echo do_shortcode('[Best_Wordpress_Gallery id="30"]');?>
        </div>
		...
		<div class="col-md-12 mb-5">
            <?php echo do_shortcode('[Best_Wordpress_Gallery id="31"]');?>
        </div>
