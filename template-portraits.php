...
<div class="container">
    <div class="page-wrap">
        ...
        <div class="col-md-12 mb-5">
            <?php echo do_shortcode('[Best_Wordpress_Gallery id="8"]');?>
        </div>
        ...
        <div class="col-md-12 mb-5">
            <?php echo do_shortcode('[Best_Wordpress_Gallery id="9"]');?>
        </div>
		...
		<div class="col-md-12 mb-5">
            <?php echo do_shortcode('[Best_Wordpress_Gallery id="28"]');?>
        </div>
		...
		<div class="col-md-12 mb-5">
            <?php echo do_shortcode('[Best_Wordpress_Gallery id="29"]');?>
        </div>
